...
type ProductionRow = {
  id: string; employee_id: string; branch_id: string; sale_id: string; production_date: string; accounting_date: string;
  production_source: "normal" | "reward" | "courtesy" | "commercial_discount" | "employee_benefit";
